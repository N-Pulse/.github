...
The project is devided in two distinct poles: the Prosthesis Pole and the BMI Pole. The prosthesis pole at N-Pulse is dedicated to the development of transradial (below elbow) and transhumeral (above elbow) arm prostheses. The Body-Machine Interface (BMI) pole of EPFL N-Pulse is focusing on the development of hardware and software to allow the human body to seamlessly connect to and control external devices. 
...
## Contributions
We welcome all contributions. Please open an issue in the repo or fork, edit, and open a pull request. Please read section [CONTRIBUTING](CONTRIBUTING.md).
